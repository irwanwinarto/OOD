...
// DATE: 1/25/2018
// REVISION HISTORY: Version 2 (last revised Jan 25 2017, 23:30)
...
/* VERSION 2 changes--------------------------------------------------------------------------------
 * Public string called concatenateThis added. Method stores the string after being 'ping-ed' and 
 * edited.
 * Precondition: must be assigned a string and accessible to cohortReps class.
 * Postcondition: the value of string may change.
 -------------------------------------------------------------------------------------------------*/
...
namespace Assignment2_Winartoi
{
    ...
    * We can query the object for the number of times it was 'ping-ed'.
    ...
    public class blurtReps
    {
        ...
        public string concatenateThis { get; set; }
