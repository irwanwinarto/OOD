...
namespace p6
{
    public class blurtSkipGen : skipGen, i_blurtReps
    {
        ...
        /*
         * gimme_sequence() - calls the gen base and returns successive numbers in the internal arithmetic sequence
         * Reliant on base (skipGen) gimme_sequence() method.
         * 
        ...
        /*
         * skip_position(int) - callse the skipGen base and skips the arithmetic value in the position number specified by argument
         * Reliant on base (skipGen) skip_position(int) method.
         * 
        ...
        public string Ping()
        {
            ...
            if (word != REP_INACTIVE && (int)num != INACTIVE_INT && (int)num != SKIPPED_INT)
                return word + " " + num;
            else if ((int)num == SKIPPED_INT)
         ...
         * Reliant on base (skipGen) gen_reset() method.
         * 
         * Preconditions: none
